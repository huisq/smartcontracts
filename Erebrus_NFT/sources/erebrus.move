module admin::erebrus{
    ...
    */
    ...
    public fun get_collection_address(): address {
        ...
        collection::create_collection_address(&res_add, &string::utf8(COLLECTION_NAME))
    }
    ...
    fun test_mint_success(
        ...
        let expected_nft_token_address = token::create_token_address(
            ...
            &string::utf8(COLLECTION_NAME),
            &string_utils::format1(&b"Erebrus #{}", state.minted)
        );
        ...
        assert!(
            token::name(nft_token_object) == string_utils::format1(&b"Erebrus #{}", state.minted),
            4
        );
        assert!(
